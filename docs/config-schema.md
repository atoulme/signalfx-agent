...
| `splunkEnabled` | no | bool |  (**default:** `false`) |
| `splunkURL` | no | string |  |
| `splunkToken` | no | string |  |
| `splunkSource` | no | string |  |
| `splunkSourceType` | no | string |  |
| `splunkIndex` | no | string |  |
| `splunkSkipTLSVerify` | no | bool |  (**default:** `false`) |
